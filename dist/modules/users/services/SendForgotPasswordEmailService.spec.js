...
describe('SendForgotPasswordEmail', function () {
    ...
    it('shold be able to recover the password using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMail;
    ...
    it('shold be able to recover a non-existing user password', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotPasswordEmail.execute({
                        email: 'w123@gmail.com',
