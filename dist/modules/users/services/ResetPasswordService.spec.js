...
describe('ResetPasswordService', function () {
    ...
    it('shold be able to reset the password', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, token, generateHash, updatedUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
                        name: 'Titico',
                        email: 'tititico123@gmail.com',
                        password: '123456',
                    })];
                case 1:
                    user = _a.sent();
    ...
    it('shold not be able to reset the password with non-existing token', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('shold not be able to reset the password with non-existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var token;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('shold be able to reset the password if passed more than 2 hours', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
